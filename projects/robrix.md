...
repo: "https://github.com/project-robius/robrix"
platform: github
...
matrix_links: []
matrix_rooms: [https://matrix.to/#/#robius:matrix.org, https://matrix.to/#/#robius-robrix:matrix.org, https://matrix.to/#/#robius-general:matrix.org]
issues: [4398]
...
- Forks: 55
- Language: Rust
- Topics: chat, makepad, matrix, matrix-org, project-robius, robius, rust
